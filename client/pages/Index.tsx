      ...
      <div className="w-full">
        <div className="flip-3d">
          <div className={`flip-3d-inner ${isFlipped ? "is-flipped" : ""}`}>
            ...
            <div className="flip-face back rounded-2xl border p-6 md:p-6 mt-4 bg-gradient-to-tr from-stone-950 to-stone-900 text-white">
              <div className="flex flex-col md:flex-row md:items-center gap-4">
                <div className="flex-1">
                  <h3 className="text-2xl md:text-3xl font-brand mb-1">
                    Biblioteca{" "}
                ...
                <div className="md:w-96 w-full">
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-full border border-stone-700 bg-stone-900/50 px-5 pr-28 py-3 text-base md:text-lg text-stone-50 placeholder:text-stone-400 shadow-sm focus:outline-none focus:ring-2 focus:ring-stone-600/30 focus:border-stone-700"
                    />
                    <button
                      onClick={() => {
                        if (isFlipped) {
                      ...
                      className="absolute right-2 top-1/2 transform -translate-y-1/2 rounded-full bg-stone-700 text-stone-50 px-4 py-2 text-sm group overflow-hidden transition-colors duration-150 ease-out focus:outline-none focus:ring-2 focus:ring-stone-600/30 hover:bg-stone-600"
                    >
                      <span className="pointer-events-none absolute inset-y-0 left-[-80%] w-[180%] -skew-x-12 bg-gradient-to-r from-white/40 via-white/20 to-white/0 opacity-0 transition-all duration-300 ease-out group-hover:left-[120%] group-hover:opacity-40" />
                  ...
                  <div className="mt-3 flex gap-2 justify-end">
                    <button
                      onClick={() => setMode("all")}
                      className={`px-3 py-1 rounded-full border text-sm ${mode === "all" ? "bg-stone-700 text-stone-50" : "bg-transparent text-stone-200 border-stone-700"}`}
                    >
                      Leybertad
                    </button>
                    <button
                      onClick={() => setMode("approved")}
                      className={`px-3 py-1 rounded-full border text-sm ${mode === "approved" ? "bg-stone-700 text-stone-50" : "bg-transparent text-stone-200 border-stone-700"}`}
                    >
                      Aprobadas (España)
                    </button>
                  </div>
